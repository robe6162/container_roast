...
def _post_install(dir):
    print('\n'.join(["\t\t   (--▒-) (--▒-)-▒)",
                     ...
                     "\t\t    \_________________/",
                     "\t\t     === ContainersRoast ===",
                     "\t\t= A ContainersCAFE Test Repository ="]))
...
setup(
    name='containersroast',
    version='0.0.1',
    description='ContainersCAFE based automated test repository',
    long_description='{0}\n\n{1}'.format(
        open('README.md').read(),
    ...
    package_dir={'containersroast': 'containersroast'},
